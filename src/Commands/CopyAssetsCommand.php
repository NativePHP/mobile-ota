...
namespace Nativephp\MobileOta\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for Ota plugin.
 *
...
{
    protected $signature = 'nativephp:ota:copy-assets';

    protected $description = 'Copy assets for Ota plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for Ota');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for Ota');
    }
}